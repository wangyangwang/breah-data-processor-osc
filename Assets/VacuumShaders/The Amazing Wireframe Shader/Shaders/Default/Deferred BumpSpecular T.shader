...
Shader "VacuumShaders/The Amazing Wireframe/Deferred/Transparent/Bumped Specular" 
{
	Properties 
	{
		//Tag
	...
	SubShader 
	{
		Tags { "Queue"="Transparent+10" 
			   ...
			   "WireframeTag"="Deferred/Transparent/Bumped Specular"
			   "WireframeBakedTag"=""
			 }
		LOD 200 
		...
		CGPROGRAM
		#pragma surface surf BlinnPhong finalcolor:wireColor alpha
