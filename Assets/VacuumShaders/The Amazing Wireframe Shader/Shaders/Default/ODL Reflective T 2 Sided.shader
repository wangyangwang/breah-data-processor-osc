...
Shader "VacuumShaders/The Amazing Wireframe/One Directional Light/Transparent/Reflective 2 Sided"
{
    Properties 
    {
		//Tag
    ...
    SubShader   
    {
		Tags { "Queue"="Transparent+10" 
			   ...
			   "WireframeTag"="One Directional Light/Transparent/Reflective 2 Sided"
			   "WireframeBakedTag"=""
			 }
