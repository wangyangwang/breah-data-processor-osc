...
Shader "VacuumShaders/The Amazing Wireframe/Vertex Color/Unlit/Gradient/Transparent 2 Sided"
{ 
    Properties 
    {
		//Tag
    ...
    SubShader 
    {
		Tags { "Queue"="Transparent+10" 
			   ...
			   "WireframeTag"="Vertex Color/Unlit/Gradient/Transparent 2 Sided"
			   "WireframeBakedTag"=""
			 }
