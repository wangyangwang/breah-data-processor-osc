...
Shader "VacuumShaders/The Amazing Wireframe/Vertex Color/Unlit/Multiply/Only Wire"
{
    Properties 
    {
		//Tag
    ...
    SubShader  
    {
		Tags { "Queue"="Transparent+20" 
			   ...
			   "WireframeTag"="Vertex Color/Unlit/Multiply/Only Wire"
			   "WireframeBakedTag"=""
			 }
