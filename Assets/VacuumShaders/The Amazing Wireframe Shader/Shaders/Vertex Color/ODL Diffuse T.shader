...
Shader "VacuumShaders/The Amazing Wireframe/Vertex Color/One Directional Light/Transparent/Diffuse"
{
    Properties 
    {
		//Tag
    ...
    SubShader   
    {
		Tags { "Queue"="Transparent+10" 
			   ...
			   "WireframeTag"="Vertex Color/One Directional Light/Transparent/Diffuse"
			   "WireframeBakedTag"=""
			 } 
