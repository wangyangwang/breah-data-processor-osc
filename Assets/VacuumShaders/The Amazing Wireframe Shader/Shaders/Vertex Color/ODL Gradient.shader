...
Shader "VacuumShaders/The Amazing Wireframe/Vertex Color/One Directional Light/Gradient/Opaque"
{
    Properties  
    {
		//Tag
    ...
    SubShader   
    {
		Tags { "Queue"="Geometry" 
		       "RenderType"="Opaque" 
			   "WireframeTag"="Vertex Color/One Directional Light/Gradient/Opaque"
			   "WireframeBakedTag"=""
			 }
