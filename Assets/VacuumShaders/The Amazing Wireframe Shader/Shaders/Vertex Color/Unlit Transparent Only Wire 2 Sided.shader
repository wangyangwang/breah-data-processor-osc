...
Shader "VacuumShaders/The Amazing Wireframe/Vertex Color/Unlit/Transparent/Wire Only 2 Sided"
{
    Properties 
    {
		//Tag
    ...
    SubShader  
    {
		Tags { "Queue"="Transparent+10" 
			   ...
			   "WireframeTag"="Vertex Color/Unlit/Transparent/Wire Only 2 Sided"
			   "WireframeBakedTag"=""
			 }
